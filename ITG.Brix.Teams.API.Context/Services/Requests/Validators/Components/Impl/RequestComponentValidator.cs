...
namespace ITG.Brix.Teams.API.Context.Services.Requests.Validators.Components.Impl
{
    public class RequestComponentValidator : IRequestComponentValidator
    {
        ...
        public ValidationResult BodyPutRequired(string put)
        {
            ValidationResult result = null;
        ...
        public ValidationResult BodyPut(string put)
        {
            ValidationResult result = null;
