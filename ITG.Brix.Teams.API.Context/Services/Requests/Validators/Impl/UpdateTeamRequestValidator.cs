...
{
    public class UpdateTeamRequestValidator : AbstractRequestValidator<UpdateTeamRequest>
    {
        private readonly IRequestComponentValidator _requestComponentValidator;

        public UpdateTeamRequestValidator(IRequestComponentValidator requestComponentValidator)
        {
        ...
        {
            var req = request as UpdateTeamRequest;
            ...
            if (result == null)
            {
                result = _requestComponentValidator.BodyPutRequired(req.BodyPut);
            }

            if (result == null)
            {
                result = _requestComponentValidator.BodyPut(req.BodyPut);
            }
